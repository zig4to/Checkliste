...
const SEED_CHECKLIST = {
  ...
  categories: [
    {
      name: "🏕️ Kamp oprema",
      items: ["Mizica", "Stoli", "Dodatna lesena mizica za razširitev", "Deka", "Piknik deka", "Viseča mreža", "Pokrivala za okna", "Toaleta", "Gajbice", "Nahrbtnik", "Nahrbtniki", "Sleep mask", "Čepki za ušesa"]
    },
    {
      name: "🍳 Kuhinja",
      items: ["Plinski gorilnik", "Bomba + cev", "Ključ za bombo", "Posoda za kuhanje", "Dober nož", "Deska za rezanje", "Pribor", "Šalce", "Kozarčki", "Krožniki", "Džezva", "Kava", "Juha", "Rezervoar z vodo", "Meh za vodo", "Hladilna skrinja + pingvini", "Tupperware", "Gobica (za posodo)", "Cet (za posodo)"]
    },
    {
      name: "🧼 Higiena",
      items: ["Brisače kopanje", "Brisače umivanje", "Gel za tuširanje", "Razkužilo za roke", "WC papir", "Kuhinjski papir", "Servieti", "Sončna krema", "Sprej proti komarjem", "Rezervne leče"]
    },
    {
      name: "🔌 Tehnika",
      items: ["Powerbanki", "USB kabli (USB/C)", "USB razdelilci", "Rezervne baterije", "Namizna lučka", "Čelka", "Slušalke", "Mašince"]
    },
    {
      name: "🩹 Orodje in popravila",
      items: ["Komplet orodja", "Plastične vrečke", "Alu folija", "Vaservaga", "Deske za uravnavanje vozila", "Štrik + klinčki", "Vezice", "Silver tape"]
    },
    {
      name: "👕 Oblačila",
      items: ["Jakna", "Jopa / dolgi rokavi", "Papuči", "Kopalke", "Sončna očala", "Rezervne vezalke"]
    },
    {
      name: "🥾 Aktivnosti",
    ...
    {
      name: "🛏️ Spanje",
      items: ["Jogi / nadvložek", "Rjuha", "Povšter", "Kovter", "Dodatna deka"]
    },
    {
      name: "🩺 Prva pomoč",
      items: ["Flajštri", "Nalgesin"]
    }
  ]
};

/** Zgradi polno checklisto iz "seed" definicije. */
function buildSeed() {
  return {
    id: uid("cl"),
    name: SEED_CHECKLIST.name,
    isTemplate: false,
    categories: SEED_CHECKLIST.categories.map((c) => ({
      id: uid("cat"),
      name: c.name,
      collapsed: false,
...
function loadStore() {
  ...
  // Prvi zagon: uvozi začetno listo (samo enkrat).
  const seed = buildSeed();
  return { activeId: seed.id, seeded: true, checklists: [seed] };
}
